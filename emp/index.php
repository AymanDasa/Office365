...
Require_once( "C:\\wow\\password\\config_eployee.php"); 
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php 
                      $emps = $dbop->query('SELECT * FROM `emp`  ')->fetchAll();
                      foreach ($emps as $row) { 
                       ...
                       echo '<tr>
                    		<td>'.$empid. '  </td>   
						<td>'.$fname.' '.$lname.'  </td>
                          	<td style="text-align: right;">'.$postion. ' </td>  
                          	<td style="text-align: right;">'.$isActive. ' </td>  
                          	<td style="text-align: right;">'.$mobile. ' </td>  
						<td>	<a href="view.php?id='.$emp_id.'" style="color: black;" >
